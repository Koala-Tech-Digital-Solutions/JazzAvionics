    ...
    <div className="about">
      ...
      <div className="about-right">
        ...
        <p>
          ...
          communication, and all essential aircraft systems, delivering top-tier
          care for your aircraft.{" "}
        </p>
        <p>
        ...
        <p>
          ...
          committed to ensuring the safety and efficiency of your aircraft with
          personalized, high-quality solutions. Contact us for more information
